  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#0A0F1F]/80 backdrop-blur-xl">
      <nav className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
        {/* Left */}
        <div className="w-40 flex justify-start mr-5">
          <a
            href="https://github.com/Richard-Halabi/snaprime-assignment"
            target="_blank"
        ...
        <Link
          to="/"
          className="text-3xl font-bold text-violet-500 no-underline whitespace-nowrap"
        >
          Snaprime Assignment
        </Link>
